...
[![GoDoc](https://godoc.org/github.com/pinqy520/dcrd/blockchain/indexers?status.png)](http://godoc.org/github.com/pinqy520/dcrd/blockchain/indexers)
...
```bash
$ go get -u github.com/pinqy520/dcrd/blockchain/indexers
```
