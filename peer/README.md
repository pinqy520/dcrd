...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/pinqy520/dcrd/peer)
...
```bash
$ go get -u github.com/pinqy520/dcrd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/pinqy520/dcrd/peer#example-package--NewOutboundPeer)  
