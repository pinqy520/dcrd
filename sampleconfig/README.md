...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/pinqy520/dcrd/sampleconfig)
...
```bash
$ go get -u github.com/pinqy520/dcrd/sampleconfig
```
